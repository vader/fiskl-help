...
description: "Manage client relationships, invitations, connections, and access levels in the Accountant Portal with flexible billing models."
keywords: ["client management", "invite clients", "client connections", "Bill Us model", "Client Pays model", "client access", "accountant portal"]
sidebar_position: 1
---
