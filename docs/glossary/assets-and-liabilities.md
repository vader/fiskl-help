...
description: "Understanding assets, liabilities, and equity accounts in your Fiskl Chart of Accounts for complete financial position tracking"
keywords: ["assets", "liabilities", "equity", "balance sheet", "accounts receivable", "accounts payable", "fixed assets", "current assets"]
sidebar_position: 2
---
...
Money or assets withdrawn from the business by the owner for personal use. Drawings reduce owner's equity but are not expenses—they represent a return of capital to the owner.
