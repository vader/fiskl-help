...
2. **A client exists** — Every invoice requires a client. You can create one during invoice creation, but having clients set up in advance is faster. See [Managing Clients](/docs/clients-vendors/managing-clients).
...
:::tip
Use payment schedules for short-term instalment billing. For long-term or indefinitely recurring billing, use [Recurring Invoices](/docs/invoicing/recurring-invoices) instead.
:::
...
- [Recurring Invoices](/docs/invoicing/recurring-invoices) — Automate regular billing
- [Tax Settings](/docs/settings/tax-settings) — Configure tax rates and display options
- [Managing Clients](/docs/clients-vendors/managing-clients) — Set up client profiles and defaults
- [Payment Gateways](/docs/banking/payment-gateways) — Connect Stripe and other payment methods