...
Fi combines platform knowledge, live data access, and regional tax guidance.
...
You can also ask follow-up questions to explore the data further. For example, ask for a profit and loss summary and then drill into a specific expense category or compare periods.
...
For common tasks, Fi walks you through the process step by step. Instead of reading a help article and switching back to Fiskl, you follow along in the conversation while Fi guides each action. This is especially useful for tasks you perform infrequently, such as setting up recurring invoices or configuring tax settings.
...
Fi draws on indexed content from official tax authorities to answer region-specific questions. Fiskl scans and indexes guidance from government tax agencies on a daily, weekly, and monthly schedule so Fi has access to current information.
...
Fiskl currently indexes content from the following tax authorities:
...
Fiskl is actively expanding coverage to additional regions. If your country's tax authority is not yet indexed, contact our support team — new sources can be added quickly.
...
1. **Classify your question** — Fi determines the type of question you are asking: a knowledge question, a data analysis request, or a task you need help completing.
2. **Route to the right approach** — Based on the classification, Fi takes one of several paths:
   ...
   - **Data and reports** — For questions about your financial data, Fi retrieves live information from your account and presents the results.
...
Mention the specific feature, report, or time period you are working with. For example, "I'm looking at my March profit and loss and the travel expenses seem high — can you break them down?" gives Fi enough context to pull the right data.
...
You can ask Fi about your revenue, clients, transactions, and tax situation with confidence that your information remains secure and private.
...
- [Getting Started](/getting-started/overview) — Learn the basics of using Fiskl
