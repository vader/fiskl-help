...
description: "How to stay safe when you receive an invoice or payment request through Fiskl. Verify the sender, spot red-flag payment methods, and report any abuse."
keywords: ["payment safety", "invoice scam", "fake invoice", "report abuse", "payment fraud", "mandate scam", "online payment", "scam prevention"]
sidebar_position: 2
tags:
  - Safety
  - Payments
...
1. **Do you know who sent it?** The name and contact details of the business should be clearly shown on the invoice.
2. **Do you know what it is for?** The line items should describe a product or service you actually ordered or agreed to.
3. **Do you know why you are receiving it now?** The amount, due date, and reason should match something you expect.
...
1. **Contact your bank or card provider** immediately. Ask them to stop the payment, reverse it, or initiate a chargeback if possible.
2. **Cancel any mandate or recurring payment** you set up as part of the same transaction.
3. **Report the invoice to Fiskl** using the **Report abuse** link on the payment page, so we can shut down the sender's account.
4. **Report the scam to your local authority:**
   - **United States:** [reportfraud.ftc.gov](https://reportfraud.ftc.gov)
   - **United Kingdom:** [actionfraud.police.uk](https://www.actionfraud.police.uk) or call 0300 123 2040
...
5. **Keep evidence.** Save the invoice, any emails, and a record of the payment. Your bank and the authorities will need these.

## Common questions

<details>
<summary>I received an invoice from a company I've never heard of. Should I pay?</summary>
...
<details>
<summary>The invoice looks real but the bank details have changed. What should I do?</summary>
...
<details>
<summary>Does Fiskl ever ask for payment in cryptocurrency?</summary>
...
<details>
<summary>I signed a mandate by mistake. How do I cancel it?</summary>
...
<details>
<summary>What happens after I report abuse?</summary>
...
- [Get Support](/support/overview.md) — Other ways to contact Fiskl if you need help
