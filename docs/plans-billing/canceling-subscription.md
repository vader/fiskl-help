...
description: "Cancel your Fiskl subscription while keeping your data intact. Learn what happens after cancellation and how to revert it."
sidebar_position: 6
keywords: ["cancel subscription", "stop billing", "pause subscription", "end subscription", "revert cancellation"]
slug: /plans-billing/canceling-subscription
tags:
  - Billing
  - Plans
  - Subscription
...
:::tip
You can revert the cancellation at any time before your subscription ends by selecting the round arrow icon on the plan card.
:::
...
:::info
Your data is never deleted when you cancel. If you re-subscribe in the future, all information will be available. However, you'll need to reconnect your banking integrations.
:::
...
| Aspect | Cancellation | Account Deletion |
|--------|-------------|------------------|
| **Data** | Kept intact | Permanently deleted |
| **Access** | Free plan features | No access |
| **Banking** | Disconnects | Disconnects |
| **Reversal** | Can re-subscribe anytime | Cannot be undone |
