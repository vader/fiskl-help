...
description: "Learn how journal entries work in Fiskl and how all financial transactions are recorded and managed in your accounting system."
keywords: ["journal entries", "account transactions", "double-entry accounting", "multi-currency", "opening balances"]
sidebar_position: 3
...
Journal entries, also referred to as account transactions, are the foundation of your accounting system. You can think of the [Chart of Accounts](/accounting/chart-of-accounts) as your folder structure and journal entries as the transactions within them.
...
<details>
<summary>Learn more about journal entry capabilities</summary>
...
For a bigger picture of your transactions you can use the [Transactions by Account](/reporting/transactions-by-account) report. Depending on your reason, you can use reports like [Balance Sheet](/reporting/balance-sheet) or [Profit and Loss (P&L)](/reporting/profit-and-loss).
...
:::info
Fiskl's accounting reports draw directly from journal entries, so keeping them accurate ensures your reports stay up-to-date.
:::
