...
Inventory tracking is now available and it is ready for live use — your stock, your ledger, your month end. We are calling it beta for one reason: it is a large feature, and once it has been used across a range of real businesses we expect to refine some of the details. Marking it beta is how we keep the room to do that.
...
Start with [Setting Up Inventory](/inventory/setting-up-inventory), and [Inventory](/inventory/overview) explains how the whole thing fits together. If something does not fit the way you work, tell us — that is what will shape the refinements.
...
Start with [Tax Management](/settings/tax-management), and [Classifying Tax Rates](/settings/tax-rate-classification) explains what each question means.

## Transfers and matching

Internal transfers and transaction matching have had their first round of improvements. This is the start of a longer piece of work rather than the end of one — more is coming in the next few releases.

## Everything else

Atlas is now available in German, French and Spanish, alongside British and American English. If you work in one of those languages, you can switch in your settings.
